      ...
      scope.renderPage = function (num) {
        ...
        pdfDoc.getPage(num).then(function (page) {
          ...
          if (pageFit) {
            ...
            var StrategyRect = element[0].getBoundingStrategyRect();
            pageWidthScale = StrategyRect.width / viewport.width;
            if (limitHeight) {
              pageWidthScale = Math.min(pageWidthScale, StrategyRect.height / viewport.height);
            }
